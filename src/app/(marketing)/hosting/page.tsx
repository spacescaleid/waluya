...
export const metadata = {
  title: "Web Hosting Enterprise - PT Waluya Nusantara",
  description: "Layanan web hosting berbasis NVMe SSD untuk bisnis Anda.",
};
      ...
      <section className="relative overflow-hidden bg-background-primary pb-24 pt-36">
        ...
        <Container>
          ...
          <p className="max-w-2xl text-lg leading-relaxed text-content-secondary">
            Layanan web hosting berbasis NVMe SSD untuk bisnis Anda.
          </p>
        </Container>
      </section>
