...
export const metadata = {
  title: "VPS Server - PT Waluya Nusantara",
  description: "VPS dengan resource terdedikasi dan root access penuh.",
};
      ...
      <section className="relative overflow-hidden bg-background-primary pb-24 pt-36">
        ...
        <Container>
          ...
          <p className="max-w-2xl text-lg leading-relaxed text-content-secondary">
            VPS dengan resource terdedikasi dan root access penuh.
          </p>
        </Container>
      </section>
